...
impl BowlingGame {
    ...
    pub fn roll(&mut self, pins: u16) -> Result<(), Error> {
        ...
        // Note: I hate this chaotic logic, but I can't think of a better way to do it right now.
        if self.throw == self.last_throw // Start a new frame if throw reaches last_throw (2 or 3)
        || (self.available_pins == 0 && !is_last_frame) // or if all pins are knocked down before reached last_throw
